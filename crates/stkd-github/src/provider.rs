...
//! provider traits from `stkd-provider-api`, enabling Stack to work with
//! GitHub repositories.
//!
//! # Example
//!
...
use stkd_provider_api::error::{ProviderError, ProviderResult};
use stkd_provider_api::traits::*;
